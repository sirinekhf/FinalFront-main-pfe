...
import VerticalBarProducts from "../../components/VerticalBarProducts";
...
import { CA_products as data } from "../../data/mockData";
...
const CAProducts = () => {
  ...
  return (
    <Box m="20px">
      <Header
        title="différences de chiffres d'affaires entre les produits"
        subtitle=""
      />
      <Box
        display="flex"
      ...
      <Box height="75vh">
        <VerticalBarProducts data={products} />
      </Box>
    </Box>
  );
};
